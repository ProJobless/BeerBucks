			...
			<div id="tools">
				...
				if($this->session->userdata('userID')){
					if($this->session->userdata('profileImage')){
						...
						echo '<div id="toolBox"><p>' . $this->session->userdata('username') . '</p><img src="" width="30" height="30" /><ul><div></div><li><a href="' . base_url() . 'index.php/profile">Profile</a></li><li><a href="' . base_url() . 'index.php/settings">Settings</a></li><li><a href="' . base_url() . 'index.php/profile">Your Parties</a></li><li><a href="' . base_url() . 'index.php/logout">Logout</a></li></ul></div>';
					}
				}else{
